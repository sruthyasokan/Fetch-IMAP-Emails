...
<html lang="en">
<head>
  <title>List Sent Emails using PHP and IMAP</title>
  <meta charset="utf-8">
...
<div class="container">
	...
	<div class="row"> 
	<h3><br>List Sent Emails using PHP and IMAP</h3> 
	<button class="btn active" onclick="getEmails()"><i class="fa fa-bars"></i>Click to get sent emails</button>
	</div>
    ...
    <br><?php
			...
			if ($mails) {
				...
				foreach ($mails as $email_number) {
					...
					VALUES ('0', 'Sentmail', '$from', '$to', '$subject', '$finalMessage1','$attachmentall','$datee')";
